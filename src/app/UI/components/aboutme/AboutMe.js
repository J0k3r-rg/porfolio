...
export default function AboutMe() {
    return (
        <section className={`border-2 px-12 py-10 rounded-lg flex flex-col ${colors.about_me.box_shadow.light} ${colors.about_me.box_shadow.dark}`}>
            ...
            <p className="text-center mt-4"> <span className="font-bold">Alcaracion: </span>Cuento con 2 repositorios de GitHub</p>
