        ...
        <div className={``}>
            ...
            <div className={`lg:hidden`}>
                ...
                <div className={`flex justify-center md:gap-4`}>
                    ...
                    <Link href={showDataSelected.github} target="_blank" className="text-rose-200 font-bold w-40 m-auto mt-4 grid place-content-center py-2 rounded-lg mb-3 shadow-[2px_2px_5px_1px_rgba(255,255,255,0.5)] bg-rose-900 bg-opacity-80">
                        {projects_texts.github}
                    </Link>
                    {
                        showDataSelected.url && <Link href={showDataSelected.url} target="_blank" className="text-rose-200 font-bold w-40 grid place-content-center m-auto py-2 rounded-lg mb-3 shadow-[2px_2px_5px_1px_rgba(255,255,255,0.5)] bg-rose-900 bg-opacity-80">
                            {projects_texts.url}
                        </Link>
                    }
                </div>
                <div className={`group-hover:grid grid grid-cols-2 md:grid-cols-4 gap-2 mt-8 justify-evenly px-4`}>
                    {
                        showDataSelected.tecnologies.map((tecnologie, index) =>
                            <p key={index} className={`px-4 py-2 rounded-2xl bg-blue-800 text-center`}>{tecnologie}</p>
                        )
                    }
                </div>
            </div>
