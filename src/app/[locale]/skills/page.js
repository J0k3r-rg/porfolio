...
export default function pageSkills() {
    ...
    return (
        <main className={`md:w-11/12 lg:w-10/12 m-auto flex flex-col lg:flex-row min-h-[calc(100vh_-_128px_-_80px)] md:grid-cols-2 items-center`}>
                <h3 className={`lg:hidden text-4xl text-center text-[#000033] dark:text-rose-500 font-bold`}>Skills</h3>
                <Habilities />
            <div className={`hidden w-6/12 relative lg:grid place-content-center lg:h-[calc(100%_-_128px_-_96px)]`}>
                ...
                <div className={`absolute w-full`}>
                    <p className={`font-bold text-6xl w-full text-center text-[#000033] dark:text-white opacity-80 dark:opacity-50 m-auto`}>JOKER</p>
                    <p className={`font-bold text-6xl w-full text-center text-[#000033] dark:text-white opacity-80 dark:opacity-50 m-auto`}>DEVELOPER FULL</p>
                    <p className={`font-bold w-full text-6xl text-center text-[#000033] dark:text-white opacity-80 dark:opacity-50`}>STACK</p>
                </div>
            </div>
